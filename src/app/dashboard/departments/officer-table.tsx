...
export function OfficerTable() {
  ...
  const [officerToDelete, setOfficerToDelete] = React.useState<IOfficer | null>(
    null,
  );
  ...
  const filteredOfficers = officers.filter((officer) => {
    ...
    const name = getOfficerFullName(officer).toLowerCase();
    return (
      ...
      officer.dila?.toLowerCase().includes(searchLower)
    );
  });
                  ...
                  <TableRow key={officer._id}>
                    ...
                    <TableCell>
                      <div className="space-y-0.5">
                        ...
                        {officer.positionType && (
                          <span
                            className={cn(
                              "inline-flex rounded-full px-2 py-0.5 text-xs font-medium",
                              getPositionBadgeClasses(officer.positionType),
                            )}
                          >
                            {getPositionTypeLabel(officer.positionType)}
                          </span>
                        )}
                      </div>
                    </TableCell>
                    <TableCell>
                      <span className="text-sm">{officer.dila || "—"}</span>
                    </TableCell>
                    <TableCell>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              {officerToDelete && getOfficerFullName(officerToDelete)} from the
              system.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              onClick={() =>
                officerToDelete && deleteMutation.mutate(officerToDelete._id)
              }
