...
import { Plus, Users, Shield, UserCheck, Crown, Briefcase } from "lucide-react";
...
export default function OfficersDashboard() {
  ...
  const executiveCount = officers.filter(
    (o) => o.positionType === PositionType.EXECUTIVE,
  ).length;
  const nazimCount = officers.filter(
    (o) => o.positionType === PositionType.HEAD,
  ).length;
  const naibCount = officers.filter(
    ...
    <div className="flex flex-col gap-6 p-6">
      ...
      <div className="grid gap-4 md:grid-cols-5">
        ...
        <StatCard
          ...
          description="State Qaid, Mut'amad"
          icon={Crown}
        />
        <StatCard
          title="Nazims (Heads)"
