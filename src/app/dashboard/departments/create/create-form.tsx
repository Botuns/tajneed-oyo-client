...
export function CreateOfficerForm() {
    ...
    const createMutation = useMutation({
        mutationFn: (data: FormValues) =>
            officerService.create(data as Omit<IOfficer, "_id" | "uniqueCode">),
        onSuccess: () => {
                            ...
                            <FormItem>
                                ...
                                <FormControl>
                                    <div className="relative">
                                        ...
                                        <Input type="email" placeholder="john@example.com" className="bg-muted pl-9" {...field} />
                                    </div>
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                            ...
                            <FormItem>
                                ...
                                <FormControl>
                                    <div className="relative">
                                        ...
                                        <Input type="tel" placeholder="+234 801 234 5678" className="bg-muted pl-9" {...field} />
                                    </div>
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                    ...
                    <FormField control={form.control} name="offices" render={({ field }) => (
                        <FormItem>
                            ...
                            <div className="max-h-48 space-y-2 overflow-y-auto rounded-lg border border-border bg-muted p-2">
                                {offices.length === 0 ? (
                                    <p className="p-4 text-center text-sm text-muted-foreground">No offices available</p>
                                ) : (
                                    offices.map((office) => (
