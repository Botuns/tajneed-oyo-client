    ...
    return (
      <div className="flex flex-col items-center justify-center py-16">
        ...
        <p className="text-sm text-muted-foreground">
          This officer may have been deleted.
        </p>
    ...
    <div className="space-y-6 p-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                {officer.position || officer.userType || "OFFICER"} •{" "}
                {officer.dila ? `${officer.dila} • ` : ""}
                {officer.email}
              </p>
            </div>
          </div>
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  This will permanently delete {getOfficerFullName(officer)}{" "}
                  from the system.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <InfoCard
          icon={Briefcase}
          label="Position"
          value={officer.position || "Not set"}
        />
        <InfoCard
          icon={Shield}
          label="Position Type"
        ...
        <InfoCard
          icon={MapPin}
          label="Dila (Local Jamaat)"
          value={officer.dila || "Not set"}
        />
        <InfoCard icon={Mail} label="Email Address" value={officer.email} />
        <InfoCard
          icon={Phone}
          label="Phone Number"
          value={officer.phoneNumber || "Not provided"}
        />
        <InfoCard
          icon={QrCode}
          label="Unique Code"
